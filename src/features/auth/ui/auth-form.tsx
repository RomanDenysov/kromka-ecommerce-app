...
export function AuthForm<T extends z.ZodType>({ schema, onSubmit, submitButtonText, fields, children }: AuthFormProps<T>) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-4'>
        ...
        {children}
        <div className='pt-4'>
          <LoaderButton size={'lg'} className='w-full font-medium' type='submit' isLoading={form.formState.isSubmitting}>
            {submitButtonText}
          </LoaderButton>
        </div>
      </form>
